...
def main():
    ...
    # train model
    model = train_model(X_train, y_train, max_depth=20, random_state=0)

    # plot feature importance
    plot_feature_importance(model, X_train, root_dir+'/reports/figures/feature_importance.png')

    # plot confusion matrix
    plot_confusion_matrix(model, X_test, y_test, root_dir+'/reports/figures/confusion_matrix.png')
    
    # plot ROC curve
    plot_roc_curve(model, X_test, y_test, root_dir+'/reports/figures/roc_curve.png')

    # plot precision-recall curve
    plot_precision_recall_curve(model, X_test, y_test, root_dir+'/reports/figures/precision_recall_curve.png')
